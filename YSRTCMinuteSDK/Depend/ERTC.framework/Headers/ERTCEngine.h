...
#import <ERTC/ERTCDef.h>
#import <ERTC/ERTCStatistics.h>
#import <ERTC/ERTCSpeedTestResult.h>
...
- (void)onReceivedLocalVideoData:(CMSampleBufferRef)receiveData;
...
///本地音频编码数据
///@param audioData 本地音频编码数据
- (void)onReceivedLocalEncodedAudioData:(NSData *)audioData;
